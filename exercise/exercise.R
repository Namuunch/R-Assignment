...
print(paste("Data type of a:", typeof(a)))
print(paste("Data type of b:", typeof(b)))
print(paste("Data type of c:", typeof(c)))
...
print(paste("Data type of d:", typeof(d)))
...
print(is.vector(lowercase_letters))

uppercase_letters_matrix <- matrix(LETTERS, nrow = 2, byrow = TRUE)
print(uppercase_letters_matrix)
print(is.matrix(uppercase_letters_matrix))
